<template>
  <div>
    <div class="card" style="margin-bottom: 5px">
      <el-input v-model="data.title" prefix-icon="Search" style="width: 240px; margin-right: 10px" placeholder="Enter guide title to search"></el-input>
      <el-input v-model="data.userName" prefix-icon="Search" style="width: 240px; margin-right: 10px" placeholder="Enter user name to search"></el-input>
    ...
    <div class="card" style="margin-bottom: 5px">
      <el-table stripe :data="data.tableData" @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="title" label="Guide">
...
const handleExport = async () => {
  request.get('/collect/export',{
    ...
    link.href = url;
    link.setAttribute('download', 'CollectInformation.xlsx');
