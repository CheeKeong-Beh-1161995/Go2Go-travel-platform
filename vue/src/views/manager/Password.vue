  ...
  <div style="width: 50%" class="card">
    <el-form ref="formRef" :rules="data.rules" :model="data.user" label-width="80px" style="padding: 20px">
      <el-form-item label="Original Password" prop="password">
        <el-input v-model="data.user.password" placeholder="Enter original password" show-password></el-input>
      </el-form-item>
      <el-form-item label="New Password" prop="newPassword">
        <el-input v-model="data.user.newPassword" placeholder="Enter new password" show-password></el-input>
      </el-form-item>
      <el-form-item label="Confirm Password" prop="confirmPassword">
        <el-input v-model="data.user.confirmPassword" placeholder="Confirm new password" show-password></el-input>
      </el-form-item>
