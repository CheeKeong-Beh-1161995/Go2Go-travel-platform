<template>
  <div>
    <div class="card" style="margin-bottom: 5px">
      <el-input v-model="data.username" prefix-icon="Search" style="width: 240px; margin-right: 10px" placeholder="Enter account to search"></el-input>
    ...
    <el-dialog title="Administrator Information" v-model="data.formVisible" width="40%" destroy-on-close>
      <el-form ref="form" :model="data.form" label-width="70px" style="padding: 20px">
        ...
        <el-form-item prop="phone" label="Phone">
          <el-input v-model="data.form.phone" placeholder="Enter phone"></el-input>
        </el-form-item>
...
const handleExport = async () => {
  request.get('/user/export',{
    ...
    link.href = url;
    link.setAttribute('download', 'UserInformation.xlsx');
